...
import { SmartphoneIcon, AppleIcon, TabletIcon, CloudIcon, BellIcon, LockIcon } from 'lucide-react';
...
export function AppDevelopment() {
  const features = [
    ...
    },
    {
      ...
      description: 'Robust security with biometric authentication and encrypted data storage.',
    },
    {
      icon: AppleIcon,
      title: 'App Store Ready',
      description: 'Full support for App Store and Google Play submission and optimization.',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="w-20 h-20 rounded-2xl bg-secondary-silver flex items-center justify-center mx-auto mb-6">
              <SmartphoneIcon className="w-10 h-10 text-primary-black" />
            </div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              and drive business growth with intuitive design and powerful
              functionality.
            </p>
          </motion.div>
